...
namespace MapleLib.WzLib.Util {
    public class MP3Header {
        ...
        private bool LoadVBRHeader(byte[] pInputheader) {
            ...
            if (pInputheader[0] == 88 && pInputheader[1] == 105 && pInputheader[2] == 110 && pInputheader[3] == 103) {
                int flags = (((pInputheader[4] & 255) << 24) | ((pInputheader[5] & 255) << 16) | ((pInputheader[6] & 255) << 8) | ((pInputheader[7] & 255)));
                if ((flags & 0x0001) == 1) {
                    intVFrames = (((pInputheader[8] & 255) << 24) | ((pInputheader[9] & 255) << 16) | ((pInputheader[10] & 255) << 8) | ((pInputheader[11] & 255)));
                    return true;
                }
                intVFrames = -1;
                return true;
        ...
        private bool IsValidHeader() {
            return (((getFrameSync() & 2047) == 2047) && ((getVersionIndex() & 3) != 1) && ((getLayerIndex() & 3) != 0) && ((getBitrateIndex() & 15) != 0) && ((getBitrateIndex() & 15) != 15) && ((getFrequencyIndex() & 3) != 3) && ((getEmphasisIndex() & 3) != 2));
        }
        ...
        private int getFrequency() {
            int[,] table = { { 32000, 16000, 8000 }, // MPEG 2.5
			                 { 0, 0, 0 }, // reserved
